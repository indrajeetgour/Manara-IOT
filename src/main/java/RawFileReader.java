...
//                );
//        XSSFBSheetHandler handler = new SheetHandler(sst);
//        parser.setContentHandler(handler);
//        return parser;
//    }
//    public static void readFromExcel() throws Exception{
//        SXSSFWorkbook myWorkBook = null;
//        FileInputStream fileIn = new FileInputStream("C:\\Manara-raw-data\\mapping\\Manara_SRS007_1_9_RTAC_public_measurements_definition.xlsx");
//
...
////            excelFilename = new HSSFWorkbook(fs);
//            if (myWorkBook != null) {
//                System.out.println("not null " + myWorkBook.toString());
//                System.out.println("Step 3");
//            } else {
//                System.out.println("myWorkBook is empty");
//                System.out.println("Step 4");
//            }
//        } catch (Exception e) {
//            System.err.println("Error on readFromExcel block");
//            e.printStackTrace();
//        }
//// TODO: 12/11/2017 handle exception if sheet not present java.lang.NullPointerException
//        //HSSFSheet sheet = excelFilename.getSheetAt(0);
//        SXSSFSheet sheet = myWorkBook.getSheet("WWApp_Tags_to_select");
//        System.out.println("Step 5");
//        //HSSFSheet sheet = excelFilename.getSheet("sheet1");
//        Map<Double, String> TagNameIdMap = new HashMap<Double, String>();
//        System.out.println("Step 6");
//        for (int rowNumber = sheet.getFirstRowNum(); rowNumber < sheet.getLastRowNum(); rowNumber++) {
//            System.out.println("Step in for loop :"+rowNumber);
//            Row row = sheet.getRow(rowNumber);
//            if (row != null) {
//                Cell scope = row.getCell(0);
//                Cell catalog = row.getCell(28);
//                Cell Description = row.getCell(4);
//                Cell DB_TagNameId = row.getCell(30);
//
...
//                    TagNameIdMap.put(DB_TagNameId.getNumericCellValue(), Description.getStringCellValue());
//                }
//            }
//        }
